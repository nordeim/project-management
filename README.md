...
| 📊 **Dashboard** | 2×2 viewport-filling grid: date card (photo rotates by time of day — morning/noon/dusk/night) + inset DONE circle beside the stats panel, Agent Activity and Goals panels below — centered stat columns whose big light numerals sit in 88px WELL squares at md+ and fluid square wells below (104→199px, `#EBE7E2` + the 3px inset pair), large-tier embossed cards on a 1200px clamped canvas with a soft purple glow |
...
| E2E tests | Playwright | 1.63 | Browser suite (26 checks): auth, path routes, goals CRUD, mobile + tablet navigation |
