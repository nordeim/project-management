...
| E2E tests | Playwright | 1.63 | Browser suite (73 checks): auth, path routes (incl. `/tasks`), goals CRUD, activity feed, mobile + tablet navigation, anchor-nav + wizard deep links, logged-out chrome, the v2.8 Tailwind-v4 parity pins (button cursor, clean chrome shadows, literal chip radius) |
