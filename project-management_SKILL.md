...
the pipeline carry `ai: true` and render the solid `#EEEAE6` AI chip (r6, pad 1/5, a 9px ZAP glyph at stroke 1.5 beside 10px/500 `#996CE4` text with 0.5px letter-spacing — v2.4: the live swapped sparkles for a lightning bolt).
