...
import { Bot, CheckSquare, LayoutDashboard, MoreHorizontal, Settings, Target, Users, X } from "lucide-react";
...
const TABS: Array<{ view: ViewId; label: string; icon: React.ReactNode }> = [
  ...
  { view: "activity", label: "Agent", icon: <Bot size={19} strokeWidth={1.8} /> },
];
